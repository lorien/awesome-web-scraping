...
- [UnblockAPI](https://unblockapi.com) - Multi-service API for AI agents and web scrapers: captcha solving (40+ types including reCAPTCHA, hCaptcha, Turnstile), headless browser rendering, screenshots, temp email, SMS verification. Flat pricing from $0.05/call. 5 free calls.
